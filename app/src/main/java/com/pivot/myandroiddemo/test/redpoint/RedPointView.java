package com.pivot.myandroiddemo.test.redpoint;
...
public class RedPointView extends FrameLayout {
    ...
    @Override
    protected void dispatchDraw(Canvas canvas) {//View的子类复写onDraw，ViewGroup的子类复写dispatchDraw
